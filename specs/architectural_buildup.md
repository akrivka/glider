...
* API + frontend - built from the glider-backend image with `glider/api_entrypoint.py`
* workers - also built from the glider-backend image with `glider/worker_entrypoint.py`
* Temporal
* SurrealDB
