"""
One-time OAuth setup script for Spotify integration.

Usage:
    python -m glider.integrations.spotify_auth_setup

This will:
1. Open a browser for Spotify OAuth consent
